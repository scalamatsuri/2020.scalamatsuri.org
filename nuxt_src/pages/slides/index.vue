...
ja:
  ...
  title_04: 当日の発表資料
  body_04:
    当日は発表資料を入れた自身のPCをご持参下さい。 接続は、HDMIまたは、アナログVGA端子が利用可能です。Macの方は、変換コネクタもご用意下さい。 もし、なんらかの事情でPCを持参できない場合には、お気軽にご相談下さい。
</i18n>
...
export default {
  head() {
    ...
    return {
      title: $t('title_01'),
      meta: [
        { name: 'og:title', content: `${$t('title_01')} | ScalaMatsuri 2020` }
      ]
    }
  }
}
