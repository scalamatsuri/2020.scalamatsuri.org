...
ja:
  ...
  section2_1: |
    ...
    の2通りの方法でスピーカーが決定されます。 <br/>
  section2_2: |
    参加者による投票:
      ScalaMatsuri参加者による投票を実施します。<br/>
      その得票数から、皆さんが特に聞きたいと思っているLTを選びます。<br/>
  ...
  section3_title: "応募"
  section3_button: <a href="https://forms.gle/6nwjzQ7N7ZPFvB5m8">セッション応募フォーム</a>  / <a href="https://forms.gle/3PSAEUeB2nTFTrKK7">追加スピーカー登録フォーム</a>
  section4_title: "応募要項"
  section4_1: |
    <ul class="section_note">
      <li class="section_note_item">内容は、Scala ビギナー もしくは Scala コミュニティが興味があると思うトピックであれば自由です。</li>
      <li class="section_note_item">LTの時間は、10分 となります。</li>
      <li class="section_note_item">話す言語は、英語もしくは日本語です。スライド本文は通常のセッションとは違い、英語でなくてもかまいません。</li>
      <li class="section_note_item">提出には、日本語で200字以内、もしくは英語で300字以内の、どちらかのタイトルが必要です。(採択後に、あらためて長めの概要の提出をお願いする場合があります。)</li>
      <li class="section_note_item">投票者がLT内容のイメージを掴むための手助けとして、キーワードを3つまで登録いただけます。このキーワードはセッション候補一覧のページに表示されます。</li>
      <li class="section_note_item">1人2セッションまで応募していただけます。ただし、投票枠、選考委員枠で複数選ばれた場合は、どれか一つを選択していただきます。</li>
